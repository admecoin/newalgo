...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("000007273c9fa211a3901a0bd8f32d80412f530ac0dd651adbb7b758dbc10fad"))
                              ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1558728142, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "the new yoek time";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1558728142;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1814324;
     // MineGenesis(genesis);
      // std::cout << genesis.ToString() << std::endl;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000007273c9fa211a3901a0bd8f32d80412f530ac0dd651adbb7b758dbc10fad"));
        assert(genesis.hashMerkleRoot == uint256("c2034e170fa0dc71c2b7f95c7d8c264ad3401391e8cc2dd6eb0b9ce817c1dfcd"));

        vSeeds.push_back(CDNSSeedData("37.143.8.42", "37.143.8.42")); 
        vSeeds.push_back(CDNSSeedData("185.87.194.125", "185.87.194.125")); 
		 vSeeds.push_back(CDNSSeedData("37.143.9.181", "37.143.9.181")); 
        vSeeds.push_back(CDNSSeedData("95.183.13.34", "95.183.13.34"));
